    ...
    posts: collection({
      ...
      schema: {
        ...
        slug: fields.slug({
          name: {
            label: "URL Slug",
            description: "The URL path for this post. Use lowercase letters, numbers, and hyphens only (e.g., 'my-post-title'). This will also become the filename.",
            validation: { isRequired: true }
          },
          slug: {
            label: "Filename",
            description: "Auto-generated from URL Slug. Do not edit - changing this will rename the file."
          }
        }),
        title: fields.text({
          label: "Title",
